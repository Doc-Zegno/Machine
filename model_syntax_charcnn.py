...
class Model:
    def __init__(self, name, sents, vectorizer_words, vectorizer_forms, embedding_size,
        ...
        self.vectorizer = HybridVectorizer(vectorizer_forms, name, embedding_size, filler=ZeroFiller(embedding_size),
                                           ce_enabled=True, tf_enabled=True)
    ...
    def train(self, sents, num_epochs, machines):
        ...
        params = list(self.vectorizer.cnn.parameters()) + list(self.tagger.parameters()) \
                 + list(self.parser.parameters())
